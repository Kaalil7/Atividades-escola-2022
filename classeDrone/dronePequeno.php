...
class DronePequeno implements Controle
{
    ...
    public function darCambalhota()
    {
        echo "</br> O drone deu uma cambalhota!";
        $this -> setCarga_bateria($this -> getCarga_bateria() - 2);
    ...
    {
        echo "</br> O drone girou em 360°!";
        $this -> setCarga_bateria($this -> getCarga_bateria() - 2);
    }

    public function visaoNoturna()
    {
        echo "</br> O drone está gravando com visão noturna! Cuidado com a bateria!";
