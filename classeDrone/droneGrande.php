...
class DroneGrande implements Controle
{
    ...
    public function getQuantHelices()
    {
        return $this->quantHelices;
    }

    public function setQuantHelices($quantHelices)
    {
    ...
    public function statusHelice(){
        echo "</br> Analisando hélices... Hélices OK!";
        $this -> setCarga_bateria($this -> getCarga_bateria() - 1);
    }
    
    public function acelerar(){
        echo "</br> Velocidade aumentada! Tenha cuidado!";
